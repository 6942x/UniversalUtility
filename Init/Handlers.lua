...
_G.UniversalUtility.Handlers.AntiAFKElements = Tabs.CreateAntiAFKTab()
_G.UniversalUtility.Handlers.KeySpamElements = Tabs.CreateKeySpamTab()
_G.UniversalUtility.Handlers.PerformanceElements = Tabs.CreatePerformanceTab()
_G.UniversalUtility.Handlers.RejoinElements = Tabs.CreateAutoRejoinTab()
_G.UniversalUtility.Handlers.LoaderElements = Tabs.CreateScriptLoaderTab()
_G.UniversalUtility.Handlers.SettingsElements = Tabs.CreateSettingsTab()
...
LoaderElements.LoadStringBox:GetPropertyChangedSignal("Text"):Connect(function()
    ...
    if LoaderElements.UpdateHighlighting then
        LoaderElements.UpdateHighlighting()
    end
end)
